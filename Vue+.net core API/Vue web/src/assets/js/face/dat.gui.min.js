  ...
  return {
    ...
    each: function (a, d, f) {
      if (e && a.forEach === e) {
        ...
        for (b in a) if (d.call(f, a[b], b) === this.BREAK) break
      }
    }, defer: function (a) {
      setTimeout(a, 0)
    }, toArray: function (c) {
...
dat.GUI = dat.gui.GUI = function (e, a, c, d, f, b, n, h, j, m, l, o, y, g, i) {
  ...
  dat.controllers.ColorController = function (e, a, c, d, f) {
    ...
    function n (b, c, e) {
      ...
      } else if (b.__state.space === 'HSV') d.extend(b.__state, a.hsv_to_rgb(b.__state.h, b.__state.s, b.__state.v)) else throw'Corrupted color state'
    }
