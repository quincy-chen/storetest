...
namespace StoreTest.WebAPI
{
    ...
    {
        ////SQLiteConnection.CreateFile(HttpContext.Current.Server.MapPath("~/App_Data") + "/stores.db");
        public static SQLiteConnection m_dbConnection = new SQLiteConnection("Data Source='"+ HttpContext.Current.Server.MapPath("~/App_Data") + "/stores.db" + "';Version=3;");
